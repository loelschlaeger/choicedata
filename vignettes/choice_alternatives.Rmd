...
The choice alternatives form the choice set from which the decision makers select [@Train2009]. In the `{choicedata}` package, these alternatives are represented as an `choice_alternatives` S3 object [@Chambers1992].  
